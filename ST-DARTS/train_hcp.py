...
from utils_hcp import batchify, get_batch, repackage_hidden, create_exp_dir, save_checkpoint

parser = argparse.ArgumentParser(description='HCPdata')
parser.add_argument('--data', type=str, default='../data/gambling/',
                    help='location of the data corpus')
parser.add_argument('--emsize', type=int, default=253,
                    help='size of word embeddings')
parser.add_argument('--nhid', type=int, default=253,
                    help='number of hidden units per layer')
parser.add_argument('--nhidlast', type=int, default=253,
...
if args.continue_train:
    ...
    model = model_hcp.RNNModel(ntokens, args.emsize, args.nhid, args.nhidlast,
                           args.dropout, args.dropouth, args.dropoutx, args.dropouti, args.dropoute,
                           cell_cls=model_hcp.DARTSCell, genotype=genotype)
...
def evaluate(data_source, batch_size=2):
